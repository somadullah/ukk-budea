...
export default function PeminjamProfile() {
  ...
  return (
    <Layout title="Profil Peminjam" allowedRoles={['peminjam', 'admin']}>
      <div className="animate-fade-in" style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '2.5rem', alignItems: 'start' }}>
          ...
          <div className="glass-card" style={{ textAlign: 'center', position: 'sticky', top: '100px' }}>
            ...
            <p style={{ fontSize: '0.8rem', color: 'var(--primary-color)', marginTop: '0.5rem' }}>Peminjam Alat</p>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                ...
                <div className="form-group">
                  ...
                  <input className="form-input" type="email" value={profile.email || ''} onChange={e => setProfile({...profile, email: e.target.value})} placeholder="peminjam@example.com" />
                </div>
              </div>
